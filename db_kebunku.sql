...
(1, 'John Doe', 'john99@gmail.com', 'Saya ingin bertanya apakah KebunKu bersedia bekerja sama dengan perusahaan kurir kami?', '2021-11-30', 'Dijawab'),
...
(28, 'Andi Simon', 'Andisimon@yahoo.com', 'aeee', '2022-01-28', 'Pending');
...
(2, 'Johannes Alexander', 'johannes', 'jojo', 'tes.png'),
...
(21, 'mencoba', 'Dudukanpot.png', 12000, 10, 12, 'keren');
...
--
ALTER TABLE `tb_jenisproduk`
  MODIFY `id_jenisproduk` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `tb_pertanyaan`
--
ALTER TABLE `tb_pertanyaan`
  MODIFY `id_pertanyaan` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
